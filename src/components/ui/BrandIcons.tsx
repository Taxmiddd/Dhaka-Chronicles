...
export function Youtube(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <polygon points="10 8.5 15 12 10 15.5 10 8.5" />
    </svg>
  )
}
...
export function Whatsapp(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M15.9 10c-.3-.1-.5-.2-.6-.2s-.3.1-.5.3c-.2.2-.4.4-.5.5-.1.1-.2.1-.5 0a3.7 3.7 0 0 1-1.3-.8 4.1 4.1 0 0 1-.9-1.1c-.2-.3 0-.4.1-.6s.3-.3.4-.5c.1-.1.1-.2.2-.3s.1-.2 0-.4-.5-1.2-.7-1.5c-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.3s-1 1-1 2.4 1 2.8 1.1 3c.1.2 2 3.1 4.9 4.3.7.3 1.2.5 1.6.6.7.2 1.3.2 1.8.1.6-.1 1.7-.7 1.9-1.3.2-.7.2-1.2.2-1.3-.1-.3-.3-.4-.6-.5z" />
    </svg>
  )
}
